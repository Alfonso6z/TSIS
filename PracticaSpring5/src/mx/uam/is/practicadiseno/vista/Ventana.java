...
public class Ventana extends JFrame implements Observador{
	...
	public Ventana(Manejador manejador) {
		...
		manejador.agregarObservador(this);
		actualiza();
	}
	/** 
	 * actualiza los dotos en la ventana
	*/
	...
	private void cerrarVentana(){
		// Elimina el registro el sujeto
		manejador.quitarObservador(this);
		// Cierra la ventana
		dispose();
	}
	/**
		...
		if (jButtonAgregar == null) {
			...
			jButtonAgregar.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					// notifica a los demas observadores que se agregaron datos
					manejador.notifica();
			...
			jButtonBorrar.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					if(getJList().getSelectedValue()!= null) {
						...
						// notifica a los demas observadores que se borraron datos
						manejador.notifica();
